...
//  Lab-VC-Transitions
//
//  Created by Chris Mitchelmore on 30/05/2014.
...
//    //// Flip the values for when excluded.
//    if ( !showExluded ){
//        excludeMinimum = maximum;
//    }
    ...
    CGContextTranslateCTM(context, CGRectGetMinX(frame) + 11.2, CGRectGetMinY(frame) + 7.2);
    CGFloat scale = (MIN(frame.size.width,frame.size.height) - 10 )/100.0;

    CGContextScaleCTM(context, scale, scale);

    UIBezierPath* backgroundPath = [UIBezierPath bezierPathWithOvalInRect: CGRectMake(-2, -2, 106, 106)];
    ...
    if (showExluded)
    {
        //// Inner 2 Drawing
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, CGRectGetMinX(frame) + 20.2, CGRectGetMinY(frame) + 16.2);
        ...
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, CGRectGetMinX(frame) + 103, CGRectGetMinY(frame) + 99);
        ...
        //// Outline 2 Drawing
        CGContextSaveGState(context);
        CGContextTranslateCTM(context, CGRectGetMinX(frame) + 13, CGRectGetMinY(frame) + 9);
        CGContextScaleCTM(context, 1.8, 1.8);
    ...
    //// Dive Icon Drawing
    CGContextSaveGState(context);
    CGContextTranslateCTM(context, CGRectGetMinX(frame) + 54, CGRectGetMinY(frame) + 49);
    ...
    CGRect calibrateMessageRect = CGRectMake(CGRectGetMinX(frame) + 54, CGRectGetMinY(frame) + 149, 100, 20);
